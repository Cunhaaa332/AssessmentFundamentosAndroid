...
class AppDatabase{
    ...
    private var musics : MutableList<Music> = mutableListOf(
        Music("I Write Sins Not Tragedies", "Panic! At the Disco", "A Fever You Can't Sweat Out", "https://www.youtube.com/watch?v=vc6vs-l5dkc"),
        Music("The Ghost Of You", "My Chemical Romance", "Three Cheers for Sweet Revenge", "https://www.youtube.com/watch?v=uCUpvTMis-Y"),
        Music("Tears Don't Fall", "Bullet For My Valentine", "The Poison", "https://www.youtube.com/watch?v=9sTQ0QdkN3Q")
    )
